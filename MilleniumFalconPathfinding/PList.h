#ifndef MILLENNIUMFALCONBACKTRACKING_PLIST_H
#define MILLENNIUMFALCONBACKTRACKING_PLIST_H
...
template <class Type> Type PList<Type>::get(int pPosition) {
...
template <class Type> int PList<Type>::remove(int pPosition) {
...
template <class Type> int PList<Type>::clear() {
    if(this->size() > 0) {
...
template <class Type> int PList<Type>::size() {
    return this->_size;
}

template <class Type> bool PList<Type>::isEmpty() {
    return (this->_head == NULL);
}
#endif //MILLENNIUMFALCONBACKTRACKING_PLIST_H